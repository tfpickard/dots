...
env.term = "kitty" --os.getenv("TERMINAL") or "xst"
env.editor = os.getenv("EDITOR") or "vim"

-- web browser
env.web_browser = "chromium" -- normal web browser, firefox, brave, chromium...
env.web_browser_term = "w3m" -- a terminal app, used to launch rss feeds from the start_screen widget

-- file browser
env.file_browser = "nn" -- terminal app only, nnn, ranger...
...
env.sound_system = "pulseaudio" -- if you use pulse, the default card @DEFAULT_SINK@ is used
