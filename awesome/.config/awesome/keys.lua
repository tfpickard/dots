...
local floating_terminal = terminal.." --class fst"
...
keys.globalkeys = gears.table.join( keys.globalkeys,
    ...
    awful.key({ alt }, "Return", function () awful.spawn("st -c fst") end,
              { description = "open a floating terminal", group = "awesome"}),

    -- superkey + 'Return' to start a terminal
    awful.key({ superkey }, "Return", function () awful.spawn(terminal) end,
              { description = "open a terminal", group = "awesome"}),

    -- superkey + 'd' to open program menu
    awful.key({ superkey }, "d", function () awful.spawn("rofi -show combi") end,
              { description = "open menu", group = "awesome"}),
