...
keys.globalkeys = gtable.join(
  awful.key({ modkey, ctrlkey   }, "h",      hotkeys_popup.show_help,
  ...
  awful.key({ modkey, }, "Return",
    function() awful.spawn.with_shell(env.term.." -e tmux") end,
  { description = "open a tmux terminal", group = "launcher" }),
  awful.key({ modkey, "Shift"}, "Return", function() awful.spawn(env.term) end,
  ...
  -- Rofi
  awful.key({ modkey }, "d", function() awful.spawn.with_shell("~/bin/launcher") end,
  ...
  awful.key({ }, "XF86MonBrightnessUp",
    function() awful.spawn.with_shell("light -A "..brinc) end,
    { description = "increase brightness by "..brinc.."%",
    group = "brightness" }),

    awful.key({ }, "XF86MonBrightnessDown",
    function() awful.spawn.with_shell("light -U "..brinc.."%") end,
    { description = "decrease brightness by "..brinc.."%",
    group = "brightness" }),

  awful.key({ "Shift" }, "XF86MonBrightnessUp",
    function() awful.spawn.with_shell("light -S "..brmax) end,
    { description = "set max ("..brmax.."%) brightness", group = "brightness" }),

    awful.key({ "Shift", }, "XF86MonBrightnessDown",
    function() awful.spawn.with_shell("light -rS "..brmin) end,
    { description = "set to min (raw "..brmin..") brightness",
      group = "brightness" })
  -- Gap
  --awful.key({ altkey }, "y",
  --function()
