...
keys.globalkeys = gtable.join(
  ...
  -- Standard program
  awful.key({ modkey, }, "Return", function() awful.spawn(env.myterm) end,
  ...
  awful.key( { }, "XF86AudioMute", function() helpers.volume_control(0) end,
  ...
  -- Brightness
    awful.key( { }, "XF86MonBrightnessDown", function() awful.spawn.with_shell("light -U 2") end,
        {description = "decrease brightness", group = "brightness"}),
    awful.key( { }, "XF86MonBrightnessUp", function() awful.spawn.with_shell("light -A 2") end,
        {description = "increase brightness", group = "brightness"}),

    awful.key( { shiftkey }, "XF86MonBrightnessDown", function() awful.spawn.with_shell("light -S 1%") end,
        {description = "decrease brightness", group = "brightness"}),
    awful.key( { shiftkey }, "XF86MonBrightnessUp", function() awful.spawn.with_shell("light -S 100%") end,
        {description = "increase brightness", group = "brightness"})
