...
local theme_name = "ElectricMetal"
...
theme.monospace_font = "Space Mono Nerd Font Complete 13"
...
local bg          = "#15131e"
local bg1         = "#1f1e2a"
-- local bg_light    = "#28344e"
-- local bg_light    = "#0e182a"
local bg_light    = "#1d1c2b"
...
theme.titlebar_fg_normal = "#e0e8ff"
theme.titlebar_fg_focus = "#e0e8ff"
...
local ex_tip = theme_folder .. "titlebar/"
-- regular
theme.titlebar_close_button_normal = ex_tip .. "close/close_normal.svg"
theme.titlebar_close_button_focus = ex_tip .. "close/close_focused.svg"
theme.titlebar_maximized_button_normal_inactive = ex_tip .. "maximize/maximize_normal.svg"
theme.titlebar_maximized_button_focus_inactive  = ex_tip .. "maximize/maximize_focused.svg"
theme.titlebar_maximized_button_normal_active = ex_tip .. "maximize/maximize_hover.svg"
theme.titlebar_maximized_button_focus_active  = ex_tip .. "maximize/maximize_hover.svg"
theme.titlebar_minimize_button_normal = ex_tip .. "minimize/minimize_normal.svg"
theme.titlebar_minimize_button_focus  = ex_tip .. "minimize/minimize_focused.svg"

-- hover
theme.titlebar_close_button_normal_hover = ex_tip .. "close/close_hover.svg"
theme.titlebar_close_button_focus_hover = ex_tip .. "close/close_hover.svg"
theme.titlebar_maximized_button_normal_inactive_hover = ex_tip .. "maximize/maximize_hover.svg"
theme.titlebar_maximized_button_focus_inactive_hover  = ex_tip .. "maximize/maximize_hover.svg"
theme.titlebar_maximized_button_normal_active_hover = ex_tip .. "maximize/maximize_hover.svg"
theme.titlebar_maximized_button_focus_active_hover  = ex_tip .. "maximize/maximize_hover.svg"
theme.titlebar_minimize_button_normal_hover = ex_tip .. "minimize/minimize_hover.svg"
theme.titlebar_minimize_button_focus_hover  = ex_tip .. "minimize/minimize_hover.svg"
...
local hogbar_location = "themes." .. theme_name .. ".hogbar.hogbar"
theme.hogbar = require(hogbar_location)

local exitpanel_location = "themes." .. theme_name .. ".exitpanel.exitpanel"
theme.exitpanel = require(exitpanel_location)
-- Hogbar theme
