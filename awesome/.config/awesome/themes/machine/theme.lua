...
theme.taglist_layout = wibox.layout.fixed.horizontal -- or vertical
...
theme.wallpaper = os.getenv("HOME") .. "/images/space.jpg" -- .. theme_name .. ".jpg"
...
theme.widget_wifi_fg = "#87aaaa"
theme.widget_wifi_bg = theme.xbackground .. "00"
theme.widget_wifi_layout = 'horizontal' -- horizontal or vertical
theme.widget_wifi_icon= ""
-- RAM
