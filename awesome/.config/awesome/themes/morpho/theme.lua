...
local layout_icon_path = os.getenv("HOME") .. "/.config/awesome/themes/anonymous/layouts/"
local xrdb = xresources.get_current_theme()
local wibox = require("wibox")
local taglist_icon_path = os.getenv("HOME") .. "/.config/awesome/themes/anonymous/taglist/"

local theme = {}

-- Get colors from .Xresources and set fallback colors
-- bg
theme.grey_dark = "#1D2021" --#161325"
...
-- Regroup fonts
theme.myfont = "Space" -- Mono for Powerline"
theme.font          = theme.myfont.." Regular 10"
theme.taglist_font = theme.myfont.." Bold 10"
theme.widget_icon_font = theme.myfont.." Mono 10"
theme.widget_text_font = theme.myfont.." Regular 10"
theme.widget_font = theme.myfont.." Mono 10"
theme.widget_icon_font_button = theme.myfont.." Mono 10"
theme.widget_title_font = theme.myfont .." Bold 12"
theme.widget_big_button_font_size = "36"
...
theme.taglist_shape_border_color = "#AF4A03"
theme.taglist_shape_border_width_empty = 0
theme.taglist_shape_border_color_empty = "#32302F"
theme.taglist_shape_border_width_focus = 1
theme.taglist_shape_border_color_focus = "#a89984"
theme.taglist_shape_border_width_urgent = 1
theme.taglist_shape_border_color_urgent = "#9d0006"
theme.taglist_shape_border_width_volatile = 1
theme.taglist_shape_border_color_volatile = "#79740e"
...
theme.menu_submenu_icon = themes_path.."morpho/submenu.png"
...
theme.wallpaper = os.getenv("HOME").."/images/space.jpg"
