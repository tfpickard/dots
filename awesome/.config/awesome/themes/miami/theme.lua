...
-- bg
theme.grey_dark = xrdb.coclor8 or "#241c22"
...
theme.double_border_normal = theme.background
...
theme.titlebar_size = 0 --dpi(20)
-- }}} End TITLEBAR

-- Top bar
theme.wibar_size = dpi(32)
theme.wibar_bg = theme.grey_dark .. "66"
